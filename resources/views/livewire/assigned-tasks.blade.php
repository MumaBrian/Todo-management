                    ...
                    <table class="text-left w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Completed At</th>
                            ...
                            @foreach ($authAssignedTasks as $task)
                                <tr class="hover:bg-grey-lighter">
                                    ...
                                    <td class="py-4 px-6 border-b border-grey-light">
                                        <button class="px-4 py-1 text-white font-light tracking-wider bg-orange-500 rounded" type="button" onclick="location.href='{{ route('admin.single_assign_task.show', $task->id) }}';">Show</button>
                                        @if (!$task->completed)
